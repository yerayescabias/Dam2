...
namespace WineShop.Controllers
{
    public class SaskiaController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SaskitikBorratuAjax(int id)
        {
            try
            {
                ...
                {
                    kendu = true,
                    mezua = "Artículo eliminado del carrito.",
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { kendu = false, mezua = "Ocurrió un error: " + ex.Message });
            }
        }
